...
--
-- Host: 127.0.0.1
-- Generation Time: May 09, 2018 at 10:31 AM
...
INSERT INTO `destinations` (`id`, `name`, `poster`, `lat`, `lng`, `map`, `province_id`, `regional_id`, `full_address`, `preview`, `about`, `created_at`, `updated_at`) VALUES
(6, 'Gunung Papandayan', 'papandayan1.jpg', 0.00, 0.00, '0', 32, 3205, 'Garut, West Java', 'as.png', '', '2018-04-30 20:15:17', '2018-04-30 20:15:17'),
(8, 'Gunung Salak', 'fix jadi.jpg', 0.00, 0.00, '0', 34, 3401, 'DIY', 'a.png', '', '2018-05-01 06:13:30', '2018-05-01 06:13:30'),
(10, 'Gunung Tangkuban Perahu', '17884441_377563865977495_6490263689224651535_n.jpg', 0.00, 0.00, '0', 32, 3204, 'Bandung, Jawa Barat', 'a.png', '', '2018-05-05 20:53:21', '2018-05-05 20:53:21'),
(11, 'GUNUNG BONGKOK', 'asd.png', 0.00, 0.00, '0', 32, 3206, 'Tasik, Jawa Barat', 'contoh latar belakang prakerin smk.gif', '', '2018-05-05 20:53:57', '2018-05-05 20:53:57'),
(14, 'as', '3602.png', 0.00, 0.00, '0', 52, 5203, 'Lombok Timur, NTT', 'a.png', '', '2018-05-06 05:15:22', '2018-05-06 05:15:22'),
(15, 'bnv', 'contoh web.png', 0.00, 0.00, '0', 61, 6106, 'ghdf', 'codeIgniter1.png', '', '2018-05-06 16:47:31', '2018-05-06 16:47:31'),
(16, 'asashd', '13668989_131741777264613_9217949567751010524_n.jpg', 0.00, 0.00, '0', 33, 3315, 'savsd', '1500780385.png', 'ashdvsd', '2018-05-08 06:24:43', '2018-05-08 06:24:43'),
(20, 'asjhsa', 'Alya Zenita 20171215_222911.jpg', 0.00, 0.00, '0', 35, 3513, 'asjhdas', '13668989_131741777264613_9217949567751010524_n.jpg', 'asjdhds', '2018-05-08 06:30:32', '2018-05-08 06:30:32');
...
(30, '2018_04_24_085010_create_destinations_table', 1),
(31, '2018_04_24_085524_create_packets_table', 1),
(32, '2018_04_24_085601_create_steps_table', 1),
(33, '2018_04_24_085755_create_photos_table', 1),
(34, '2018_04_24_090011_create_adventures_table', 1),
(35, '2018_04_24_091505_create_packet_selects_table', 1),
(36, '2018_04_24_091620_create_packet_items_table', 1),
(37, '2018_04_24_092659_create_provinces_table', 1),
(38, '2018_04_24_092718_create_regionals_table', 1),
(39, '2018_04_24_094647_create_transactions_table', 1),
(40, '2018_04_24_094748_create_posts_table', 1),
(41, '2018_04_24_094818_create_tags_table', 1),
(42, '2018_04_24_110942_create_routes_table', 1);
...
CREATE TABLE `packets` (
  ...
  `count_adults` int(11) NOT NULL,
  `count_kids` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
...
--
-- Table structure for table `packet_items`
--
...
CREATE TABLE `packet_items` (
  ...
  `about_item` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `packet_items`
--

INSERT INTO `packet_items` (`id`, `icon`, `name`, `about_item`, `created_at`, `updated_at`) VALUES
(37, 'codeIgniter1.png', 'Packet Item 1', 'packet item 1 help you for climbing', '2018-04-28 17:39:16', '2018-04-28 17:46:56'),
(38, 'B62xj9FCUAA3YoC.png', 'Packet Item 2', 'Packet Item 2 help you for climbing', '2018-04-28 17:46:23', '2018-04-28 17:46:23'),
(39, 'logoitb.png', 'Packet Item 3', 'Packet Item 3 help you for climbing', '2018-04-28 17:47:40', '2018-04-28 17:47:40'),
(40, 'Logo-Universitas-Pendidikan-Indonesia.png', 'Packet Item 4', 'Packet Item 4 help you for climbing', '2018-04-28 17:48:22', '2018-04-30 01:25:31'),
(41, '21317782_447879158945965_7779013384319342096_n.jpg', 'Huhu', 'huhu', '2018-05-08 01:07:25', '2018-05-08 01:07:25'),
(42, '20170817_Google_Chrome_logo_vector_download.png', 'iii', 'iii', '2018-05-08 01:08:38', '2018-05-08 01:08:38');

-- --------------------------------------------------------

--
-- Table structure for table `packet_selects`
--

CREATE TABLE `packet_selects` (
  `id` int(10) UNSIGNED NOT NULL,
...
CREATE TABLE `posts` (
  ...
  `description` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `user_id` int(11) NOT NULL,
  `type` enum('news','blog') COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `posts` (`id`, `title`, `poster`, `description`, `user_id`, `type`, `created_at`, `updated_at`) VALUES
(3, 'asdasd', '21317782_447879158945965_7779013384319342096_n.jpg', 'asdas', 1, 'news', '2018-05-01 23:19:11', '2018-05-01 23:19:11'),
(10, 'awyt', 'a.png', 'waheg', 3, 'news', '2018-05-05 14:36:53', '2018-05-05 14:36:53'),
(11, 'asy', 'asd.png', 'assah', 3, 'news', '2018-05-05 14:38:57', '2018-05-05 14:39:13'),
(13, 'asjhdgd', 'Alya Zenita 20171215_222911.jpg', 'afsyafs', 3, 'blog', '2018-05-06 16:20:07', '2018-05-06 16:20:07'),
(14, 'asjjs', '20170817_Google_Chrome_logo_vector_download.png', 'adshgdahs', 3, 'blog', '2018-05-06 16:20:24', '2018-05-06 16:20:24'),
(15, 'adhgdas', 'codeigniter-logo.png', 'adsjgjads', 3, 'news', '2018-05-06 16:20:43', '2018-05-06 16:20:43'),
(16, 'adjsgajdo', 'ass.png', 'znbds', 3, 'news', '2018-05-06 16:20:57', '2018-05-06 16:43:56');
...
INSERT INTO `regionals` (`id`, `province_id`, `name`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `steps` (`id`, `level`, `destination_id`, `description`, `sum_point`, `sub_point`, `created_at`, `updated_at`) VALUES
(1, 1, 6, 'huhu', 10, -25, '2018-05-01 05:05:40', '2018-05-01 05:05:40'),
(2, 2, 6, 'Hihi', 45, -11, '2018-05-01 05:22:51', '2018-05-01 05:22:51'),
(5, 9, 8, 'Amazing Stepi', 21, 22, '2018-05-01 06:14:03', '2018-05-01 06:55:21'),
(6, 12, 8, 'Huhu', 144, -20, '2018-05-01 06:56:11', '2018-05-01 14:12:25'),
(7, 7, 8, 'Haha', 11, -11, '2018-05-01 06:56:34', '2018-05-01 06:56:34');
...
CREATE TABLE `transactions` (
  ...
  `packet_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `status` enum('ordered','checked','payment','finish') COLLATE utf8mb4_unicode_ci NOT NULL,
  `proof` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `users` (
  ...
  `born_at` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `born_date` date NOT NULL,
  `telp` char(15) COLLATE utf8mb4_unicode_ci NOT NULL,
  `photo` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `address` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `point` int(11) NOT NULL,
  `level` enum('admin','climber') COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `users` (`id`, `username`, `password`, `email`, `first_name`, `last_name`, `gender`, `born_at`, `born_date`, `telp`, `photo`, `address`, `point`, `level`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 'ahmad_irfanm', '$2y$10$Ehs/iwlXNLyAXWr/Np4dtO8TxWi4dzBx84PwjI8CMb7/CCjBqlRR.', '', 'Ahmad', 'Irfan Maulana', 'M', 'Subang', '2002-04-03', '0896-1869-4788', 'default.png', '', 0, 'admin', 'p07AmgbzdTVCg5tdxo4vuZLBteywWNFqiUpbbPLrf3R8MoyGW2URVv1lP9dG', '2018-04-24 22:29:48', '2018-04-24 22:29:48'),
(3, 'alyazenita_', '$2y$10$2LfHtCutmsCjbVF49AM8x.dRYGyH82Kgsh1yNaaaLan0y684T363C', 'alya@pemuncak.com', 'Alya', 'Zenita', 'F', 'Subang', '2001-05-27', '0892-7231-2787', 'default.png', '', 0, 'climber', 'QmoVQ5ScCfqAlSSK8EisNTm1XNlvxyJcPPvmLP2nOYcC8avVgIFtrf9wt5rA', '2018-04-24 23:05:12', '2018-04-24 23:05:12'),
(4, 'admin', '$2y$10$x19/GNe8F4KHQpvkiZJN.e1ewVfEXkbuQIBgbWOxX6BN4VMTPjjha', 'admin@pemuncak.com', 'Administrator', 'Pemuncak', 'M', 'Subang', '2002-04-03', '', 'default.png', '', 0, 'admin', NULL, '2018-05-05 06:11:33', '2018-05-05 06:11:33');
...
--
-- Indexes for table `packet_items`
--
ALTER TABLE `packet_items`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `packet_selects`
--
ALTER TABLE `packet_selects`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `packets`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `packet_items`
--
ALTER TABLE `packet_items`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
--
-- AUTO_INCREMENT for table `packet_selects`
--
ALTER TABLE `packet_selects`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
