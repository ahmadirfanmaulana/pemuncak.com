...
<!-- Mirrored from themepixels.me/slim/template/page-404.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 22 Apr 2018 00:18:29 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  <body>
    ...
    <div class="page-error-wrapper">
      <div>
        ...
        <p class="mg-b-50"><a href="{{ route('logged') }}" class="btn btn-error">Back to Dashboard</a></p>
